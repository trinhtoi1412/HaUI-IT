...
create database MarkManagement
  on primary(
	...
	filename = 'C:\Users\Trinh Toi - HaUI\Documents\HaUI Learning\SQL Server\LMS\Bai1\MarkManagement_DB.mdf',
	size = 10mb,
	maxsize = 100mb,
	filegrowth = 10mb
  )
  log on(
	...
	filename = 'C:\Users\Trinh Toi - HaUI\Documents\HaUI Learning\SQL Server\LMS\Bai1\MarkManagement_Log.ldf',
	size = 10mb,
	maxsize = 100mb,
	filegrowth = 10mb
 )
